...
async function generatePDF(html){ // Takes HTML as input
  const data = {
    ...
    footerTemplate: `
    <div style="display: flex; width: 100%; justify-content: space-between; font-size: 12px; align-items: center">
      <div style="text-align: left;">This invoice was generated by a computer system and is subject to human review and verification.</div>
